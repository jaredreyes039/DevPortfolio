			...
			<section className="ultrawide:mb-12 mobilesc:max-md:mb-24 px-12 py-4 flex flex-1 mobilesc:max-md:flex-col">
				<div className="md:top-[15%] absolute mobilesc:max-md:pt-24 md:left-1/4 flex flex-col justify-center z-20">
					<TypeIt className="mb-24 mobilesc:max-md:mb-12" options={{
						...
						<h1 className="mobilesc:leading-loose mobilesc:max-md:tracking-normal ultrawide:text-8xl 2xl:text-8xl lg:max-xl:text-7xl mobilesc:max-md:text-3xl text-white">Conquering</h1>
						<h1 className="mobilesc:leading-loose mobilesc:max-md:tracking-normal ultrawide:text-8xl 2xl:text-8xl lg:max-xl:text-7xl mobilesc:max-md:text-3xl text-white">My <span className="mobilesc:leading-loose mobilesc:max-md:tracking-normal text-green-300">Mind</span></h1>
						<h1 className="mobilesc:leading-loose mobilesc:max-md:tracking-normal ultrawide:text-8xl 2xl:text-8xl lg:max-xl:text-7xl mobilesc:max-md:text-3xl text-white">To <span className="mobilesc:leading-loose mobilesc:max-md:tracking-normal " >Build</span></h1>
						<h1 className="mobilesc:leading-loose mobilesc:max-md:tracking-normal ultrawide:text-8xl 2xl:text-8xl lg:max-xl:text-7xl mobilesc:max-md:text-3xl text-white">A <span className="mobilesc:leading-loose mobilesc:max-md:tracking-normal px-4 py-2 mx-2 my-2 rounded-lg bg-grad text-white">Brighter Future</span></h1>
					</TypeIt>
