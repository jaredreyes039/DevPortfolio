			...
			<section className="mobilesc:max-md:mb-6 md:mb-[320px] pt-24 md:pt-48  mobilesc:px-6 md:px-12 py-4 flex flex-1 lg:max-xl:min-h-[320px] mobilesc:max-md:flex-col">
				<div className="xl:top-[20%] absolute xl:left-1/4 flex flex-col justify-center z-20">
					<TypeIt className="mb-6 mobilesc:max-md:mb-12" options={{
						...
						<h1 className="mobilesc:leading-loose mobilesc:max-md:tracking-normal ultrawide:text-8xl md:max-ultrawide:text-7xl mobilesc:max-md:text-3xl text-white">Conquering</h1>
						<h1 className="mobilesc:leading-loose mobilesc:max-md:tracking-normal ultrawide:text-8xl md:max-ultrawide:text-7xl mobilesc:max-md:text-3xl text-white">My <span className="mobilesc:leading-loose mobilesc:max-md:tracking-normal text-green-300">Mind</span></h1>
						<h1 className="mobilesc:leading-loose mobilesc:max-md:tracking-normal ultrawide:text-8xl md:max-ultrawide:text-7xl mobilesc:max-md:text-3xl text-white">To <span className="mobilesc:leading-loose mobilesc:max-md:tracking-normal " >Build</span></h1>
						<h1 className="mobilesc:leading-loose mobilesc:max-md:tracking-normal ultrawide:text-8xl md:max-ultrawide:text-7xl mobilesc:max-md:text-3xl text-white">A <span className="mobilesc:leading-loose mobilesc:max-md:tracking-normal px-4 py-2 mx-2 my-2 rounded-lg bg-grad text-white">Brighter Future</span></h1>
					</TypeIt>
				...
				<div className="flex flex-col justify-center w-full bg-shadow h-96 relative">
					<div className="ultrawide:w-5/6 xl:w-3/4 md:max-xl:w-[85%] mobilesc:max-sm:bottom-[45%] absolute z-0 left-[15%] mobilesc:max-ultrawide:left-[30%] xs:max-xl:top-[-5%] xl:max-ultrawide:top-[-25%]">
